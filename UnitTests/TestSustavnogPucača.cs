...
namespace UnitTests
{
    ...
    {
        [TestMethod]
        public void SustavniPucač_UputiPucanjVraćajLijevoIliDesnoPoljeZaHorizontalniSmjer()
        {
        ...
        [TestMethod]
        public void SustavniPucač_UputiPucanjVraćajDonjePoljeIliDonjePoljeZaVertikalniSmjer()
        {
            List<Polje> pogođenaPolja = new List < Polje > { new Polje(0, 2), new Polje(1, 2)};
            Mreža mreža = new Mreža(10, 10);
            SustavniPucač p = new SustavniPucač(pogođenaPolja, mreža);
        ...
        [TestMethod]
         public void SustavniPucač_UputiPucanjVraćajDesnoPoljeZaVertikalniSmjerakoJeLijevoPoljeVećEliminirano()
        {
            List<Polje> pogođenaPolja = new List < Polje > { new Polje(3, 2), new Polje(3, 3)};
            Mreža mreža = new Mreža(10, 10);
